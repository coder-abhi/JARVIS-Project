...
export default function HelpingHandsTransactionsPage() {
  ...
  const transactions = useMemo(() => {
    ...
    return processed.filter((transaction) => {
  ...
  }, [data, directionFilter, memberFilter, periodFilter]);
        ...
        <div className="helping-table-wrap">
          <div className="helping-all-transactions-table">
            <div className="helping-all-transaction-row head">
              <span>Date</span><span>Member</span><span>Direction</span><span>Amount</span><span>Automatic Allocation</span><span>Note</span><span>Actions</span>
            </div>
